...
class BookCategory(models.Model):
    ...
    name = models.CharField(verbose_name="category name", max_length=50, null=False)
    abbrev = models.CharField(verbose_name="abbreviation", max_length=3, null=False)
    description = models.CharField(  # NOQA
        verbose_name="description", max_length=150, blank=True, null=True
    )
...
class Book(models.Model):
    ...
    title = models.CharField(verbose_name="title", max_length=30, null=False)
...
class BookPage(models.Model):
    ...
    content = models.TextField(  # NOQA
        verbose_name="page content", max_length=600, null=True
    )
